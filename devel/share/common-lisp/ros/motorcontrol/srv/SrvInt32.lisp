...
(cl:in-package motorcontrol-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SrvInt32-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvInt32-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name motorcontrol-srv:<SrvInt32-request> is deprecated: use motorcontrol-srv:SrvInt32-request instead.")))

(cl:ensure-generic-function 'arg1-val :lambda-list '(m))
(cl:defmethod arg1-val ((m <SrvInt32-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motorcontrol-srv:arg1-val is deprecated.  Use motorcontrol-srv:arg1 instead.")
  (arg1 m))
...
(cl:defmethod cl:initialize-instance :after ((m <SrvInt32-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvInt32-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name motorcontrol-srv:<SrvInt32-response> is deprecated: use motorcontrol-srv:SrvInt32-response instead.")))

(cl:ensure-generic-function 'val-val :lambda-list '(m))
(cl:defmethod val-val ((m <SrvInt32-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motorcontrol-srv:val-val is deprecated.  Use motorcontrol-srv:val instead.")
  (val m))
